...
Print["Check the definition of `GatherCoefficients`"];
GatherCoefficients[expr: Except[_List],var_List]:=Map[Times@@#&,GatherBy[List@@expr,And@@(Function[x,FreeQ[#,x]]/@var)&]]
GatherCoefficients[expr: Except[_List],var: Except[_List]]:=Map[Times@@#&,GatherBy[List@@expr,And@@(Function[x,FreeQ[#,x]]/@{var})&]]
